...
import { FlatList, StyleSheet, Text, View, marginTop, 
    ...
    function Home5( {navigation} ) {
      const [number5, setnumber] = useState(0);
      ...
      return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          ...
          <Button title ="next" onPress= {() => navigation.navigate('1번문제')}/>
          
          <Image 
          source ={require('../../assets/305.png')}
          style={{width:'90%', height:"39%"}}></Image>
