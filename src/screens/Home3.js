...
import { FlatList, StyleSheet, Text, View, marginTop, 
    ...
    function Home3( {navigation} ) {
      ...
      const [number3, setnumber] = useState(0);
    
    
      const putandnext1 = function(){
        setnumber(1);
        Alert.alert('동작함');
        navigation.navigate('4번문제')
      }
      ...
      return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          ...
          <Button title ="next" onPress= {() => navigation.navigate('4번문제')}/>
          <Image 
          source ={require('../../assets/303.png')}
          style={{width:'100%', height:"42%"}}></Image>
