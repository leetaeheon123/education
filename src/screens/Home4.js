...
import { FlatList, StyleSheet, Text, View, marginTop, 
    ...
    function Home4( {navigation} ) {
      ...
      const [number4, setnumber] = useState(0);
    
      const putandnext1 = function(){
        setnumber(1);
        Alert.alert('동작함');
        navigation.navigate('5번문제')
      }
      ...
      return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          ...
          <Button title ="next" onPress= {() => navigation.navigate('5번문제')}/>
          
         
          <Image 
          source ={require('../../assets/304.png')}
